<?php
/**
 * RusLabel functions and definitions
 *
...
if ( ! function_exists( 'ruslabel_setup' ) ) :
	...
	function ruslabel_setup() {
		 ...
		 * If you're building a theme based on RusLabel, use a find and replace
		 * to change 'ruslabel' to the name of your theme in all the template files.
		 */
...
function ruslabel_scripts() {
	...
	wp_enqueue_script( 'ruslabel-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'ruslabel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
